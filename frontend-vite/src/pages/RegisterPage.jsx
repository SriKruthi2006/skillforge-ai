  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <form className="w-full max-w-md p-8 bg-white rounded shadow" onSubmit={submit}>
        ...
        <input className="w-full p-3 border rounded mb-3" placeholder="Your name" value={name} onChange={e=>setName(e.target.value)} />
        ...
        <button className="w-full p-3 bg-indigo-600 text-white rounded" disabled={loading}>{loading? 'Creating...':'Create account'}</button>
